...
# Lấy thời gian cuối cùng trong ds1 và tạo chuỗi thời gian mới cho ds2
...
# Cập nhật thời gian cho ds2
ds2 = ds2.assign_coords(time=("time", adjusted_times))

# Lấy dữ liệu của toa_incident_solar_radiation và mở rộng với chiều time mới
...
# Tạo lại toa_incident_solar_radiation với chiều time mới
toa_incident_solar_radiation = xr.DataArray(
