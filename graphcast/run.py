...
if source == "Random":
    ...
    params_path = os.path.join(params_directory, 'GraphCast_small - ERA5 1979-2015 - resolution 1.0 - pressure levels 13 - mesh 2to5 - precipitation input and output.npz')
...
plot_pred_variable_value = "2m_temperature"  # Biến muốn hiển thị
